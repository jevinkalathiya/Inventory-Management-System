                        ...
                        <div class="col-lg-6 col-md-12 col-6 mb-6">
                            <div class="card h-100">
                                <div class="card-body pb-4">
                                    <span class="d-block fw-medium mb-1" data-i18n="Total Purchase Amt">Total Purchase Amt</span>
                                    <h4 class="card-title mb-0">276k</h4>
                                </div>
                                <div id="purchaseChart" class="pb-3 pe-1"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-6 mb-6">
                            <div class="card h-100">
                                <div class="card-body pb-4">
                                    <span class="d-block fw-medium mb-1" data-i18n="Total Sales Amt">Total Sales Amt</span>
                                    <h4 class="card-title mb-0">276k</h4>
                                </div>
                                <div id="salesChart" class="pb-3 pe-1"></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-6 mb-6">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <p class="mb-1" data-i18n="Profit">Profit</p>
                        ...
                        <div class="col-lg-6 col-md-12 col-6 mb-6">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <p class="mb-1" data-i18n="Customers">Customers</p>
                                    <h4 class="card-title mb-3">$4,679</h4>
                                    <small class="text-success fw-medium">&nbsp</small>
                                </div>
                            </div>
                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex justify-content-between">
                      ...
                      <div class="dropdown">
                        ...
                        >
                          <i
                            class="icon-base bx bx-dots-vertical-rounded icon-lg"
                          ></i>
                        </button>
                        <div
                ...
                <div class="col-md-6 col-lg-4 order-1 mb-6">
                  <div class="card h-100">
                    <div class="card-header nav-align-top">
                      <ul
                        class="nav nav-pills flex-wrap row-gap-2"
                        role="tablist"
                      >
                        <li class="nav-item">
                          <button
                            ...
                            <div>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                <small class="text-success fw-medium">
                                  <i
                                    class="icon-base bx bx-chevron-up icon-lg"
                                  ></i>
                                  42.9%
                                </small>
                              </div>
