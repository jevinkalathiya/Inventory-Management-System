...
<head>
    ...
    <title>@yield('title','SmartStock') - SmartStock</title>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">SmartStock</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-header small">
                        <span class="menu-header-text" data-i18n="Category & Products">Category &amp; Products</span>
                    </li>
                    <li class="menu-item @menuOpen('*/category*')">
                        <a href="app-user-list.html" class="menu-link menu-toggle">
                            <i class="menu-icon icon-base fa-light fa-boxes-stacked"></i>
                            <div data-i18n="Category">Category</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item @active('list/category')">
                    ...
                    <li class="menu-item @menuOpen('*/product*')">
                        <a href="app-access-roles.html" class="menu-link menu-toggle">
                            <i class="menu-icon icon-base fa-light fa-box"></i>
                            <div data-i18n="Products">Products</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item @active('list/product')">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                            ...
                            <li class="nav-item dropdown-language dropdown me-2 me-xl-0">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0);" data-language="hi"
                                            data-text-direction="ltr">
                                            <span>Hindi</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0);" data-language="gu"
                                            data-text-direction="ltr">
                                            <span>Gujarati</span>
                                        </a>
                                    </li>
...
@yield('content')
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl">
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                Developed by
                                <a href="https://linkedin.com/in/jevinkalathiya" target="_blank" class="footer-link">Jevin
                                    Kalathiya</a>
                            </div>
                        </div>
                    </div>
    ...
    @if (request()->is('list/*'))
        ...
        @if ($type == 'category')
            <script src="{{ asset('assets/js/category-list.js') }}"></script>
        @elseif ($type == 'product')
