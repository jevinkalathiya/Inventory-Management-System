  ...
  return function() {
    ...
    function O(e) {
      var t,
        ...
        n,
        o =
          (t = c((e.version || "").split(".").map(Number), 2),
            r = t[0],
            n = t[1],
          ...
          t.length > 0 && t.reduce(function(e, t) {
            ...
            return [].concat(
              ...
              m(
                function(e) {
                  for (
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 20, r = [], n = 0;
                    n < e.objectIDs.length;
                    n += t
                  ) r.push(b(b({}, e), {}, { objectIDs: e.objectIDs.slice(n, n + t) }));
                  return r;
                }(b(b({}, n), {}, {
    ...
    function _(e) {
      var t = e.items.reduce(function(e, t) {
        var r;
        return e[t.__autocomplete_indexName] = (null !== (r = e[t.__autocomplete_indexName]) && void 0 !== r ? r : [])
          .concat(t),
          e;
      }, {});
    ...
    var D = "2.15.0",
      ...
      k = r(function(e) {
        ...
        t({
          insights: n,
          insightsEvents: _({ items: r }).map(function(e) {
    ...
    function x(e) {
      ...
      if (
        o || function(e) {
          ...
          "string" == typeof r && (m = t[r]),
            m || (t.AlgoliaAnalyticsObject = r,
              t[r] || (t[r] = function() {
                t[r].queue || (t[r].queue = []);
      ...
      return {
        ...
        subscribe: function(e) {
          ...
          m("addAlgoliaAgent", "insights-plugin"),
            o(),
            m("onUserTokenChange", function(e) {
              o(e);
            }),
            ...
            r(function(e) {
              ...
              S(t)
                && s({
                  ...
                  insights: v,
                  item: t,
                  insightsEvents: [E({ eventName: "Item Selected" }, a({ item: t, items: o.getItems().filter(S) }))],
                });
            }),
            n(function(e) {
                      ...
                      Promise.all(
                        e.filter(function(e) {
                          ...
                          if (e.sourceId, r.includes(e.sourceId)) {
                            throw new Error(
                              "[Autocomplete] The `sourceId` ".concat(JSON.stringify(e.sourceId), " is not unique."),
                            );
                          }
                          r.push(e.sourceId);
                          var t = {
      ...
      return t.map(function(t) {
        var n,
          ...
          a = u
            ...
            : i;
        return t.onResolve({ source: t, results: i, items: a, state: r.getState() }),
          Array.isArray(a),
          a.every(Boolean),
          "The `getItems` function from source \"".concat(t.sourceId, "\" must return an array of items but returned ")
            .concat(
    ...
    function ge(e, t) {
      ...
      return {
        then: function(t, n) {
          ...
          return t && r.onCancelList.push(t),
            ge(
              e.finally(_e(
                t && function() {
    ...
    function Te(e) {
      ...
      if (f(i), p(o.defaultActiveItemId), !i && !1 === o.openOnFocus) {
        var y,
          d = a.getState().collections.map(function(e) {
      ...
      m("loading"),
        xe = o.environment.setTimeout(function() {
          m("stalled");
        }, o.stallThreshold);
      var g = Oe(Ne(
        o.getSources(Ie({ query: i, refresh: u, state: a.getState() }, c)).then(function(e) {
          return Promise.all(e.map(function(e) {
            return Promise.resolve(e.getItems(Ie({ query: i, refresh: u, state: a.getState() }, c))).then(function(t) {
            ...
            n
              && v({
                algoliaInsightsPlugin: Ie(
                  Ie(
                    {},
                    (null === (r = a.getState().context) || void 0 === r ? void 0 : r.algoliaInsightsPlugin) || {},
                  ),
                  {},
            ...
            return function(e) {
              ...
              return F(r.reshape({ sourcesBySourceId: i, sources: Object.values(i), state: n })).filter(Boolean).map(
                function(e) {
        ...
        if (null !== a.getState().activeItemId && p) {
          ...
          b.onActive(
            Ie({ event: t, item: v, itemInputValue: y, itemUrl: d, refresh: u, source: b, state: a.getState() }, c),
          );
        }
      }).finally(function() {
    ...
    function qe(e) {
      return qe = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ? function(e) {
          return typeof e;
        }
        : function(e) {
      ...
      return {
        ...
        getRootProps: function(e) {
          return Ye({
            ...
            "aria-controls": n.getState().isOpen
              ? n.getState().collections.map(function(e) {
                var r = e.source;
        ...
        getFormProps: function(e) {
          ...
          return Ye({
            ...
            onSubmit: function(i) {
              var u;
              i.preventDefault(),
                t.onSubmit(Ye({ event: i, refresh: r, state: n.getState() }, o)),
            ...
            onReset: function(i) {
              var u;
              i.preventDefault(),
                t.onReset(Ye({ event: i, refresh: r, state: n.getState() }, o)),
        ...
        getInputProps: function(e) {
          ...
          function a(e) {
            ...
            && Te(
              Ye({ event: e, props: t, query: n.getState().completion || n.getState().query, refresh: r, store: n }, o),
          ...
          return Ye({
            ...
            "aria-activedescendant": n.getState().isOpen && null !== n.getState().activeItemId
              ? Be(t.id, "item-".concat(n.getState().activeItemId), null == p ? void 0 : p.source)
              : void 0,
            "aria-controls": n.getState().isOpen
              ? n.getState().collections.map(function(e) {
                var r = e.source;
            ...
            onChange: function(e) {
              ...
              t.ignoreCompositionEvents && Ve(e).isComposing
                ? o.setQuery(i)
                : Te(Ye({ event: e, props: t, query: i.slice(0, s), refresh: r, store: n }, o));
            },
            onCompositionEnd: function(e) {
              Te(Ye({ event: e, props: t, query: e.currentTarget.value.slice(0, s), refresh: r, store: n }, o));
            },
            onKeyDown: function(e) {
              Ve(e).isComposing || function(e) {
                ...
                if ("ArrowUp" === t.key || "ArrowDown" === t.key) {
                  var u = function() {
                      var e = Se(o.getState()),
                        t = r.environment.document.getElementById(
                          Be(r.id, "item-".concat(o.getState().activeItemId), null == e ? void 0 : e.source),
                        );
                  ...
                  t.preventDefault(),
                    !1 === o.getState().isOpen && (r.openOnFocus || Boolean(o.getState().query))
                      ? Te(Fe({ event: t, props: r, query: o.getState().query, refresh: n, store: o }, i)).then(
                        function() {
                  ...
                  if (
                    null === o.getState().activeItemId || o.getState().collections.every(function(e) {
                      return 0 === e.items.length;
                    })
                  ) return void (r.debug || o.pendingRequests.cancelAll());
                  t.preventDefault();
                  var c = Se(o.getState()), l = c.item, s = c.itemInputValue, f = c.itemUrl, p = c.source;
                  if (t.metaKey || t.ctrlKey) {
                    void 0 !== f
                      && (p.onSelect(
                        ...
                        r.navigator.navigateNewTab({ itemUrl: f, item: l, state: o.getState() }));
                  } else if (t.shiftKey) {
                    void 0 !== f
                      && (p.onSelect(
                        Fe({
                        ...
                        r.navigator.navigateNewWindow({ itemUrl: f, item: l, state: o.getState() }));
                  } else if (t.altKey);
                  else {
                    if (void 0 !== f) {
                      return p.onSelect(
                        ...
                        void r.navigator.navigate({ itemUrl: f, item: l, state: o.getState() });
                    }
                    Te(Fe({ event: t, nextState: { isOpen: !1 }, props: r, query: s, refresh: n, store: o }, i)).then(
                      function() {
                        p.onSelect(
                          Fe({
                            event: t,
        ...
        getItemProps: function(e) {
          ...
          return Ye({
            ...
            onMouseMove: function(e) {
              if (i.__autocomplete_id !== n.getState().activeItemId) {
                ...
                if (null !== n.getState().activeItemId && t) {
                  ...
                  l.onActive(
                    Ye(
                      { event: e, item: u, itemInputValue: a, itemUrl: c, refresh: r, source: l, state: n.getState() },
                      o,
                    ),
                  );
                }
            ...
            onClick: function(e) {
              ...
              (c
                ? Promise.resolve()
                : Te(Ye({ event: e, nextState: { isOpen: !1 }, props: t, query: a, refresh: r, store: n }, o))).then(
                  function() {
                    u.onSelect(
                      Ye({
                        event: e,
    ...
    function ct(e) {
      var t,
        ...
        u = e.options,
        a =
          null === (t = ((null === (r = u.__autocomplete_metadata) || void 0 === r ? void 0 : r.userAgents) || [])[0])
            || void 0 === t
            ? void 0
            : t.segment,
        c = a
          ? at(
            {},
            a,
            Object.keys((null === (n = u.__autocomplete_metadata) || void 0 === n ? void 0 : n.options) || {}),
          )
          : {};
      return {
    ...
    function lt(e) {
      ...
      return !1 === r.isOpen || null === r.activeItemId
        ? null
        : (null === (t = Se(r)) || void 0 === t ? void 0 : t.itemInputValue) || null;
    }
    function st(e, t, r, n) {
      if (!r) return null;
    ...
    function ft(e) {
      return ft = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ? function(e) {
          return typeof e;
        }
        : function(e) {
    ...
    var yt = function(e, t) {
      switch (t.type) {
        ...
        case "ArrowDown":
          var r = mt(mt({}, e), {}, {
            activeItemId: t.payload.hasOwnProperty("nextActiveItemId")
              ...
              : st(1, e.activeItemId, W(e), t.props.defaultActiveItemId),
          });
        ...
        case "Escape":
          return e.isOpen
            ? mt(mt({}, e), {}, { activeItemId: null, isOpen: !1, completion: null })
    ...
    function dt(e) {
      return dt = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ? function(e) {
          return typeof e;
        }
        : function(e) {
    ...
    function Ot(e) {
      var t = [],
        ...
        n = L(yt, r, function(e) {
          ...
          if (
            r.onStateChange(gt({ prevState: i, state: l, refresh: u, navigator: r.navigator }, o)),
              !c() && null !== (t = l.context) && void 0 !== t && null !== (n = t.algoliaInsightsPlugin) && void 0 !== n
              && n.__automaticInsights && !1 !== r.insights
          ) {
        ...
        i = tt(gt({ props: r, refresh: u, store: n, navigator: r.navigator }, o));
      function u() {
        return Te(
          gt({
      ...
      return a(r.plugins),
        function(e) {
          ...
          if (
            null === (t = o.navigator) || void 0 === t || null === (r = t.userAgent) || void 0 === r
              ? void 0
        ...
        }({ metadata: ct({ plugins: r.plugins, options: e }), environment: r.environment }),
        gt(gt({ refresh: u, navigator: r.navigator }, i), o);
    }
    var _t = function(e, t, r, n) {
        ...
        for (var i = 1; i < t.length; i++) {
          ...
          3 === u
            ...
            ? n[1][t[++i]] += a + ""
            : u
            ? (o = e.apply(a, _t(e, a, r, ["", null])), n.push(o), a[0] ? t[0] |= 2 : (t[i - 2] = 0, t[i] = o))
            : n.push(a);
        }
        return n;
      },
    ...
    function jt(e) {
      var t = St.get(this);
      return t || (t = new Map(), St.set(this, t)),
        (t = _t(
            this,
            t.get(e) || (t.set(
              e,
                  ...
                  var t,
                    ...
                    a = function(e) {
                      1 === n && (e || (o = o.replace(/^\s*\n\s*|\s*\n\s*$/g, "")))
                        ...
                        ? u.push(5, 0, !0, o)
                        : n >= 5
                          && ((o || !e && 5 === n) && (u.push(n, 0, o, r), n = 6), e && (u.push(n, e, 0, r), n = 6)),
                        o = "";
                    },
                    c = 0;
                  c < e.length;
                    ...
                    t = e[c][l],
                      1 === n
                        ...
                        : n && ("=" === t
                          ? (n = 5, r = o, o = "")
                          : "/" === t && (n < 5 || ">" === e[c][l + 1])
                          ? (a(), 3 === n && (u = u[0]), n = u, (u = u[0]).push(2, 0, n), n = 0)
                          : " " === t || "\t" === t || "\n" === t || "\r" === t
                          ? (a(), n = 2)
                          : o += t),
                      3 === n && "!--" === o && (n = 4, u = u[0]);
    ...
    var Pt = function(e) {
      ...
      It = function(e) {
        ...
        return t.setAttribute("class", "aa-LoadingIcon"),
    ...
    function Ct(e, t, r) {
      ...
      if ("style" === t) {
        ...
        else for (t in r) i && r[t] === i[t] || At(e.style, t, r[t]);
      } else {"o" === t[0] && "n" === t[1]
          ? (n = t !== (t = t.replace(/Capture$/, "")),
            ((o = t.toLowerCase()) in e || Et.includes(o)) && (t = o),
            t = t.slice(2),
            e._listeners || (e._listeners = {}),
            e._listeners[t] = r,
            r ? i || e.addEventListener(t, Dt, { passive: true }) : e.removeEventListener(t, Dt, n))
          : "list" !== t && "tagName" !== t && "form" !== t && "type" !== t && "size" !== t && "download" !== t
              && "href" !== t && t in e
          ? e[t] = null == r ? "" : r
          : "function" != typeof r && "dangerouslySetInnerHTML" !== t
            && (null == r || !1 === r && !/^ar/.test(t) ? e.removeAttribute(t) : e.setAttribute(t, r));}
    }
    function kt(e) {
      switch (e) {
        case "onChange":
    ...
    function pr(e, t, r) {
      ...
      if (
        arguments.length > 2 && (u.children = arguments.length > 3 ? Jt.call(arguments, 2) : r),
    ...
    function gr(e) {
      (!e.__d && (e.__d = !0) && Zt.push(e) && !hr.__r++ || er !== Xt.debounceRendering)
        && ((er = Xt.debounceRendering) || tr)(hr);
    }
    function hr() {
      var e, t, r, n, o, i, u, a;
      for (Zt.sort(rr); e = Zt.shift();) {
        e.__d && (t = Zt.length,
          n = void 0,
          i = (o = (r = e).__v).__e,
          u = [],
          ...
          && ((n = sr({}, o)).__v = o.__v + 1,
            ...
            Ar(u, n, a),
            n.__e != i && br(n)),
          Zt.length > t && Zt.sort(rr));
      }
      hr.__r = 0;
    }
    function Or(e, t, r, n, o, i, u, a, c, l, s) {
      var f, p, m, v, y, d = n && n.__k || ar, b = t.length;
      for (r.__d = c, _r(r, t, d), c = r.__d, f = 0; f < b; f++) {
        null != (m = r.__k[f]) && (p = -1 === m.__i ? ur : d[m.__i] || ur,
          m.__i = f,
          Er(e, m, p, o, i, u, a, c, l, s),
          v = m.__e,
          m.ref && p.ref != m.ref && (p.ref && Cr(p.ref, null, m), s.push(m.ref, m.__c || v, m)),
          null == y && null != v && (y = v),
            ...
            (o =
              e.__k[n] =
                "string" == typeof o || "number" == typeof o || "bigint" == typeof o || o.constructor == String
                  ? mr(null, o, null, null, null)
                  : lr(o)
                  ? mr(vr, { children: o }, null, null, null)
                  : void 0 === o.constructor && o.__b > 0
                  ? mr(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v)
                  : o).__ = e,
            o.__b = e.__b + 1,
            i = null,
            -1 !== (a = o.__i = jr(o, r, u, s)) && (s--, (i = r[a]) && (i.__u |= 131072)),
            null == i || null === i.__v
              ? (-1 == a && f--, "function" != typeof o.type && (o.__u |= 65536))
              : a !== u && (a == u - 1 ? f-- : a == u + 1 ? f++ : (a > u ? f-- : f++, o.__u |= 65536)))
          : o = e.__k[n] = null;
      }
      if (s) {
        for (n = 0; n < l; n++) {
          null != (i = r[n]) && !(131072 & i.__u) && (i.__e == e.__d && (e.__d = dr(i)), kr(i, i));
        }
      }
    }
    function Sr(e, t, r) {
    ...
    function Pr(e, t, r) {
      "-" === t[0]
        ...
        : e[t] = null == r ? "" : "number" != typeof r || cr.test(t) ? r : r + "px";
    }
    function wr(e, t, r, n, o) {
      ...
      e: if ("style" === t) {
        ...
        i = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, "$1")),
          ...
          e.l[t + i] = r,
          r
            ? n ? r.u = n.u : (r.u = nr, e.addEventListener(t, i ? ir : or, i))
            : e.removeEventListener(t, i ? ir : or, i);
      } else {
        if ("http://www.w3.org/2000/svg" == o) t = t.replace(/xlink(H|:h)/, "h").replace(/sName$/, "s");
        else if (
          "width" != t && "height" != t && "href" != t && "list" != t && "form" != t && "tabIndex" != t
          && "download" != t && "rowSpan" != t && "colSpan" != t && "role" != t && "popover" != t && t in e
        ) {
          try {
            e[t] = null == r ? "" : r;
            break e;
        ...
        try {
          if (
            b = t.props,
              ...
              h = (s = I.contextType) && n[s.__c],
              O = s ? h ? h.props.value : s.__ : n,
              r.__c
                ? d = (f = t.__c = r.__c).__ = f.__E
                : (g ? t.__c = f = new I(b, O) : (t.__c = f = new yr(b, O), f.constructor = I, f.render = xr),
                  h && h.sub(f),
                  f.props = b,
                  f.state || (f.state = {}),
                  f.context = O,
                  ...
                  f.__h = [],
                  f._sb = []),
              g && null == f.__s && (f.__s = f.state),
              g && null != I.getDerivedStateFromProps
              && (f.__s == f.state && (f.__s = sr({}, f.__s)), sr(f.__s, I.getDerivedStateFromProps(b, f.__s))),
              m = f.props,
              v = f.state,
              f.__v = t,
              p
          ) {
            g && null == I.getDerivedStateFromProps && null != f.componentWillMount && f.componentWillMount(),
              g && null != f.componentDidMount && f.__h.push(f.componentDidMount);
          } else {
            if (
              g && null == I.getDerivedStateFromProps && b !== m && null != f.componentWillReceiveProps
              && f.componentWillReceiveProps(b, O),
                !f.__e
                && (null != f.shouldComponentUpdate && !1 === f.shouldComponentUpdate(b, f.__s, O) || t.__v === r.__v)
            ) {
              for (
                t.__v !== r.__v && (f.props = b, f.state = f.__s, f.__d = !1),
                  t.__e = r.__e,
                  t.__k = r.__k,
            ...
            null != f.componentWillUpdate && f.componentWillUpdate(b, f.__s, O),
              g && null != f.componentDidUpdate && f.__h.push(function() {
                f.componentDidUpdate(m, v, y);
              });
          }
          if (f.context = O, f.props = b, f.__P = e, f.__e = !1, S = Xt.__r, j = 0, g) {
            for (
              f.state = f.__s, f.__d = !1, S && S(t), s = f.render(f.props, f.state, f.context), P = 0;
              P < f._sb.length;
              P++
            ) f.__h.push(f._sb[P]);
            f._sb = [];
          ...
          f.state = f.__s,
            null != f.getChildContext && (n = sr(sr({}, n), f.getChildContext())),
            g && !p && null != f.getSnapshotBeforeUpdate && (y = f.getSnapshotBeforeUpdate(m, v)),
            Or(
              e,
              lr(w = null != s && s.type === vr && null == s.key ? s.props.children : s) ? w : [w],
              t,
              r,
              n,
              o,
    ...
    function Dr(e, t, r, n, o, i, u, a, c) {
      ...
      if (
        "svg" === g
          ...
          : o || (o = "http://www.w3.org/1999/xhtml"), null != i
      ) {
      ...
      if (null === g) d === b || a && e.data === b || (e.data = b);
        ...
        if (i = i && Jt.call(e.childNodes), d = r.props || ur, !a && null != i) {
          for (d = {}, l = 0; l < e.attributes.length; l++) {
            d[(m = e.attributes[l]).name] = m.value;
          }
        }
        for (l in d) {
          if (m = d[l], "children" == l);
        ...
        for (l in b) {
          m = b[l],
            "children" == l
              ...
              : "checked" == l
              ? y = m
              : a && "function" != typeof m || d[l] === m || wr(e, l, m, d[l], o);
        }
        ...
        a
          || (l = "value",
            "progress" === g && null == v
              ...
              : void 0 !== v && (v !== e[l] || "progress" === g && !v || "option" === g && v !== d[l])
                && wr(e, l, v, d[l], o),
            l = "checked",
            void 0 !== y && y !== e[l] && wr(e, l, y, d[l], o));
      }
      return e;
    }
    function Cr(e, t, r) {
    ...
    function kr(e, t, r) {
      ...
      if (
        Xt.unmount && Xt.unmount(e),
          (n = e.ref) && (n.current && n.current !== e.__e || Cr(n, null, t)),
          null != (n = e.__c)
      ) {
    ...
    function Nr(e, t, r) {
      ...
      Xt.__ && Xt.__(e, t),
        ...
        Er(
          t,
          e = (!n && r || t).__k = pr(vr, null, [e]),
          o || ur,
          ur,
          t.namespaceURI,
          !n && r ? [r] : o ? null : t.firstChild ? Jt.call(t.childNodes) : null,
          i,
    ...
    Jt = ar.slice,
        ...
        __e: function(e, t, r, n) {
          for (var o, i, u; t = t.__;) {
            if ((o = t.__c) && !o.__) {
              try {
                if (
                  (i = o.constructor) && null != i.getDerivedStateFromError
                  && (o.setState(i.getDerivedStateFromError(e)), u = o.__d),
                    null != o.componentDidCatch && (o.componentDidCatch(e, n || {}), u = o.__d),
                    u
                ) return o.__E = o;
              } catch (t) {
                e = t;
      ...
      yr.prototype.setState = function(e, t) {
        var r;
        r = null != this.__s && this.__s !== this.state ? this.__s : this.__s = sr({}, this.state),
          "function" == typeof e && (e = e(sr({}, r), this.props)),
          e && sr(r, e),
          null != e && this.__v && (t && this._sb.push(t), gr(this));
      },
      yr.prototype.forceUpdate = function(e) {
        this.__v && (this.__e = !0, e && this.__h.push(e), gr(this));
      },
      yr.prototype.render = vr,
      Zt = [],
      tr = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout,
      rr = function(e, t) {
          ...
          return {
            ...
            add: function(t) {
              ...
              (null == r ? void 0 : r.isHighlighted) === t.isHighlighted
                ? e[e.length - 1] = { value: r.value + t.value, isHighlighted: r.isHighlighted }
                : e.push(t);
            },
          };
    ...
    function Mr(e) {
      ...
      function n(e) {
        ...
        return t(
          r,
          {},
          Ur({ hit: n, attribute: o }).map(function(e, r) {
    ...
    function Kr(e) {
      return Kr = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ? function(e) {
          return typeof e;
        }
        : function(e) {
    ...
    function Yr(e) {
      ...
      function n(e) {
        ...
        return t(
          r,
          {},
          (n = { hit: o, attribute: i }, Xr(Ur(n))).map(function(e, r) {
    ...
    function rn(e) {
      ...
      function n(e) {
        ...
        return t(
          r,
          {},
          (n = { hit: o, attribute: i }, Xr(tn(n))).map(function(e, r) {
            return e.isHighlighted ? t(a, { key: r }, e.value) : e.value;
          }),
        );
      }
    ...
    function nn(e) {
      ...
      function n(e) {
        ...
        return t(
          r,
          {},
          tn({ hit: n, attribute: o }).map(function(e, r) {
            return e.isHighlighted ? t(u, { key: r }, e.value) : e.value;
          }),
        );
      }
    ...
    function an(e) {
      return an = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ? function(e) {
          return typeof e;
        }
        : function(e) {
    ...
    function dn(e) {
      var t = e.panelPlacement,
        ...
        u = (o.pageYOffset || o.document.documentElement.scrollTop || o.document.body.scrollTop || 0) + i.top
          + i.height;
      switch (t) {
        case "start":
    ...
    function bn(e) {
      return bn = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ? function(e) {
          return typeof e;
        }
        : function(e) {
    ...
    function wn(e) {
      return wn = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ? function(e) {
          return typeof e;
        }
        : function(e) {
    ...
    function Un(e) {
          ...
          return function(e) {
            ...
            return {
              renderer: {
                ...
                renderNoResults: y,
                renderer: j,
                detachedMediaQuery: null != b
                  ? b
                  : getComputedStyle(_.document.documentElement).getPropertyValue("--aa-detached-media-query"),
          ...
          return Ot(Ln(Ln({}, v.value.core), {}, {
            onStateChange: function(e) {
              ...
              f.current = e.state.collections.some(function(e) {
                ...
                null === (r = (n = v.value.core).onStateChange) || void 0 === r || r.call(n, e);
            },
        ...
        _ = l(function() {
          return function(e) {
            var t = e.autocomplete,
              ...
              b = c.getLabelProps(zt({ state: s, props: t.getLabelProps({}) }, r)),
              g = p("button", {
              ...
              _ = p("div", { class: n.loadingIndicator, children: [It({ environment: o })] }),
              S = Qt({
                class: n.input,
                environment: o,
                state: s,
              ...
              C = p("div", { class: n.detachedSearchButtonQuery, textContent: s.query }),
              k = p("div", { class: n.detachedSearchButtonPlaceholder, hidden: Boolean(s.query), textContent: a });
            if (i) {
      ...
      function j(e) {
        ...
        !function(e) {
          ...
          Nt(n.root, o.getRootProps(On({ state: i, props: t.getRootProps({}) }, r))),
            Nt(
              n.input,
              o.getInputProps(
                On({ state: i, props: t.getInputProps({ inputElement: n.input }), inputElement: n.input }, r),
              ),
            ),
            xt(n.label, { hidden: "stalled" === i.status }),
            xt(n.loadingIndicator, { hidden: "stalled" !== i.status }),
            xt(n.clearButton, { hidden: !i.query }),
            xt(n.detachedSearchButtonQuery, { textContent: i.query }),
            xt(n.detachedSearchButtonPlaceholder, { hidden: Boolean(i.query) });
        }(t),
          function(e, t) {
            var r = t.autocomplete,
              ...
              f = t.renderer;
            if (l.isOpen) {
              a.contains(u.panel) || "loading" === l.status || a.appendChild(u.panel),
                u.panel.classList.toggle("aa-Panel--stalled", "stalled" === l.status);
              var p = l.collections.filter(function(e) {
                  ...
                  return f.createElement(
                    "section",
                    { key: t, className: o.source, "data-autocomplete-source-id": u.sourceId },
                    u.templates.header
                      && f.createElement(
                        "div",
                    ...
                    u.templates.noResults && 0 === a.length
                      ...
                      : f.createElement(
                        ...
                        gn(
                          { className: o.list },
                          c.getListProps(On({ state: l, props: r.getListProps({ source: u }) }, n)),
                        ),
                        a.map(function(e) {
                          var t = r.getItemProps({ item: e, source: u });
                          return f.createElement(
                            "li",
                            gn({ key: t.id, className: o.item }, c.getItemProps(On({ state: l, props: t }, n))),
                            u.templates.item({
                              components: s,
                              createElement: f.createElement,
                              Fragment: f.Fragment,
              ...
              e(
                On(On({ children: m, state: l, sections: p, elements: v }, f), {}, { components: s, html: i }, n),
                u.panel,
              );
      ...
      function w(e) {
        e !== v.value.core.environment.document.body.contains(_.value.detachedOverlay)
          && (e
            ? (v.value.core.environment.document.body.appendChild(_.value.detachedOverlay),
              v.value.core.environment.document.body.classList.add("aa-Detached"),
              _.value.input.focus())
            : (v.value.core.environment.document.body.removeChild(_.value.detachedOverlay),
      ...
      return i(function() {
        ...
        i(function() {
          ...
          return m.current = function(t) {
            ...
            (y.value && n.isOpen !== r.isOpen && w(r.isOpen),
              y.value || !r.isOpen || n.isOpen || S(),
              r.query !== n.query)
        ...
        i(function() {
          var e = r(function() {
            var e = y.value;
            y.value = v.value.core.environment.matchMedia(v.value.renderer.detachedMediaQuery).matches,
              e !== y.value ? P({}) : requestAnimationFrame(S);
          }, 20);
        ...
        i(function() {
          ...
          var r = v.value.core.environment.matchMedia(
            getComputedStyle(v.value.core.environment.document.documentElement).getPropertyValue(
