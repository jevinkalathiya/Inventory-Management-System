              ...
              var n = function() {
                  ...
                  return function() {
                      ...
                      function(n) {
                        ...
                        s = function(e, t) {
                          ...
                          return e = i[1],
                            r && (n = w(r = m(r, o))),
                            r
                              ? e = n && n.normalize ? n.normalize(e, y(o)) : m(e, o)
                              : (r = (i = $(e = m(e, o)))[0], e = i[1], r && (n = w(r))),
                          ...
                          r = function(e, t, i, r) {
                            ...
                            if (m = b(r = r || e), "undefined" === x || "function" === x) {
                              for (
                                t = !t.length && i.length ? ["require", "exports", "module"] : t, f = 0;
                                f < t.length;
                                f += 1
                              ) {
                                if ("require" === (u = (h = s(t[f], m)).f)) $[f] = a.require(e);
                                else if ("exports" === u) $[f] = a.exports(e), y = !0;
                                else if ("module" === u) o = $[f] = a.module(e);
                                else if (g(l, u) || g(c, u) || g(d, u)) $[f] = w(u);
                                else {
                                  if (!h.p) throw new Error(e + " missing " + u);
                                  h.p.load(h.n, v(r, !0), _(u), {}), $[f] = l[u];
                                }
                              }
                          ...
                          e = t = o = function(e, t, i, l, c) {
                            if ("string" == typeof e) return a[e] ? a[e](t) : w(s(e, b(t)).f);
                            if (!e.splice) {
                    ...
                    n.define("select2/utils", ["jquery"], function(e) {
                      ...
                      t.Extend = function(e, t) {
                        ...
                        t.Decorate = function(e, t) {
                          ...
                          function o() {
                            ...
                            i > 0 && (n.call(arguments, e.prototype.constructor), r = t.prototype.constructor),
                      ...
                      i.prototype.on = function(e, t) {
                        ...
                        t.hasScroll = function(t, n) {
                          ...
                          return (r !== o || "hidden" !== o && "visible" !== o)
                            && ("scroll" === r || "scroll" === o || i.innerHeight() < n.scrollHeight
                      ...
                      return t.GetUniqueElementId = function(e) {
                        ...
                        return null == t
                          && (e.id
                            ...
                            : (e.setAttribute("data-select2-id", ++r), t = r.toString())),
                          t;
                      },
                        ...
                        t.GetData = function(n, i) {
                          ...
                          return i
                            ? t.__cache[r] && null != t.__cache[r][i] ? t.__cache[r][i] : e(n).data(i)
                            : t.__cache[r];
                        },
                    ...
                    n.define("select2/results", ["jquery", "./utils"], function(e, t) {
                      ...
                      return t.Extend(n, t.Observable),
                        ...
                        n.prototype.append = function(e) {
                          ...
                          } else {0 === this.$results.children().length
                        ...
                        n.prototype.setClasses = function() {
                          ...
                          this.data.current(function(i) {
                            ...
                            n.$results.find(".select2-results__option[aria-selected]").each(function() {
                              ...
                              null != i.element && i.element.selected || null == i.element && e.inArray(o, r) > -1
                        ...
                        n.prototype.option = function(n) {
                          ...
                          var r = { role: "option", "aria-selected": "false" },
                            o = window.Element.prototype.matches || window.Element.prototype.msMatchesSelector
                              || window.Element.prototype.webkitMatchesSelector;
                          for (
                            var s
                              in (null != n.element && o.call(n.element, ":disabled")
                          ...
                          if (n.children) {
                            ...
                            for (var u = [], d = 0; d < n.children.length; d++) {
                              var p = n.children[d], h = this.option(p);
                              u.push(h);
                            }
                            var f = e("<ul></ul>", {
                        ...
                        n.prototype.bind = function(n, i) {
                          ...
                          this.$results.attr("id", o),
                            ...
                            n.on("select", function() {
                              n.isOpen()
                                && (r.setClasses(), r.options.get("scrollAfterSelect") && r.highlightFirstItem());
                            }),
                        ...
                        i.prototype._handleBlur = function(t) {
                          ...
                          window.setTimeout(function() {
                            document.activeElement == n.$selection[0]
                              || e.contains(n.$selection[0], document.activeElement) || n.trigger("blur", t);
                          }, 1);
                        },
                      ...
                      function(e, t, n, i) {
                        ...
                        return n.Extend(r, t),
                          ...
                          r.prototype.bind = function(e, t) {
                            ...
                            this.$selection.find(".select2-selection__rendered").attr("id", i).attr("role", "textbox")
                      ...
                      return i.prototype.render = function(t) {
                        ...
                        i.prototype.resizeSearch = function() {
                          ...
                          e = "" !== this.$search.attr("placeholder")
                            ...
                            : .75 * (this.$search.val().length + 1) + "em", this.$search.css("width", e);
                        },
                        i;
                    }),
                    ...
                    n.define("select2/data/select", ["./base", "../utils", "jquery"], function(e, t, n) {
                      ...
                      return t.Extend(i, e),
                        ...
                        i.prototype._normalizeItem = function(e) {
                          ...
                          return null != (e = n.extend({}, { text: "" }, e)).id && (e.id = e.id.toString()),
                            null != e.text && (e.text = e.text.toString()),
                            null == e._resultId && e.id && null != this.container
                        ...
                        i.prototype.query = function(e, t) {
                          ...
                          function o() {
                            var o = r.transport(r, function(r) {
                              ...
                              i.options.get("debug") && window.console && console.error
                              && (!o || !o.results || n.isArray(o.results)), t(o);
                            }, function() {
                              (!("status" in o) || 0 !== o.status && "0" !== o.status)
                      ...
                      return t.prototype.query = function(e, t, n) {
                        ...
                        function r(e, o) {
                          for (var s = e.results, a = 0; a < s.length; a++) {
                            var l = s[a], c = null != l.children && !r({ results: l.children }, !0);
                    ...
                    n.define("select2/data/tokenizer", ["jquery"], function(e) {
                      ...
                      return t.prototype.bind = function(e, t, n) {
                        ...
                        t.prototype.query = function(t, n, i) {
                          ...
                          a.term !== n.term
                          && (this.$search.length && (this.$search.val(a.term), this.$search.trigger("focus")),
                            n.term = a.term), t.call(this, n, i);
                        },
                    ...
                    n.define("select2/dropdown/infiniteScroll", ["jquery"], function(e) {
                      ...
                      return t.prototype.append = function(e, t) {
                        ...
                        t.prototype.loadMoreIfNeeded = function() {
                          ...
                          !this.loading && t
                            && this.$results.offset().top + this.$results.outerHeight(!1) + 50
                      ...
                      return n.prototype.bind = function(e, t, n) {
                        ...
                        n.prototype._positionDropdown = function() {
                          ...
                          (e.contains(document.body, p[0]) || p[0].isConnected) && (h = p.offset()),
                            ...
                            null != r
                            && (this.$dropdown.removeClass("select2-dropdown--below select2-dropdown--above").addClass(
                              "select2-dropdown--" + r,
                            ),
                              this.$container.removeClass("select2-container--below select2-container--above").addClass(
                                "select2-container--" + r,
                              )),
                        ...
                        n.prototype._resizeDropdown = function() {
                          ...
                          && (e.minWidth = e.width, e.position = "relative", e.width = "auto"), this.$dropdown.css(e);
                        },
                      ...
                      return t.prototype.bind = function(e, t, n) {
                        ...
                        t.prototype._handleSelectOnClose = function(t, n) {
                          ...
                          if (!(r.length < 1)) {
                            ...
                            null != o.element && o.element.selected || null == o.element && o.selected
                    ...
                    n.define("select2/defaults", [
                      ...
                      "./i18n/en",
                    ], function(e, t, n, i, r, o, s, a, l, c, u, d, p, h, f, g, m, v, y, _, w, $, b, x, A, D, C, S, E) {
                      function O() {
                        this.reset();
                      }
                    ...
                    n.define("select2/options", ["require", "jquery", "./defaults", "./utils"], function(e, t, n, i) {
                      ...
                      return r.prototype.fromElement = function(e) {
                        ...
                        for (var s = 0; s < e[0].attributes.length; s++) {
                          var a = e[0].attributes[s].name, l = "data-";
                          if (a.substr(0, l.length) == l) {
                            var c = a.substring(l.length), u = i.GetData(e[0], c);
                            r[c.replace(/-([a-z])/g, o)] = u;
                          }
                        }
                        t.fn.jquery && "1." == t.fn.jquery.substr(0, 2) && e[0].dataset
                          && (r = t.extend(!0, {}, e[0].dataset, r));
                        var d = t.extend(!0, {}, i.GetData(e[0]), r);
                        for (var p in d = i._convertData(d)) {
                          t.inArray(p, n) > -1 || (t.isPlainObject(this.options[p])
                    ...
                    n.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function(e, t, n, i) {
                      ...
                      return n.Extend(r, n.Observable),
                          ...
                          this.on("open", function() {
                            ...
                            this.on("keypress", function(t) {
                              ...
                              e.isOpen()
                                ...
                                : (n === i.ENTER || n === i.SPACE || n === i.DOWN && t.altKey)
                        ...
                        r.prototype._isChangeMutation = function(t, n) {
                          ...
                          if (!t || !t.target || "OPTION" === t.target.nodeName || "OPTGROUP" === t.target.nodeName) {
                            if (n) {
                              ...
                              } else {n.removedNodes && n.removedNodes.length > 0
                                  ? i = !0
                                  : e.isArray(n) && e.each(n, function(e, t) {
                        ...
                        r.prototype.val = function(t) {
                          if (
                            this.options.get("debug") && window.console && console.warn, null == t || 0 === t.length
                    ...
                    n.define("select2/compat/inputData", ["jquery", "../utils"], function(e, t) {
                      ...
                      return n.prototype.current = function(t, n) {
                        function i(t, n) {
                          var r = [];
                          return t.selected || -1 !== e.inArray(t.id, n)
                    ...
                    function(t) {
                      ...
                      var t,
                        ...
                        r = "onwheel" in document || document.documentMode >= 9
                          ? ["wheel"]
                      ...
                      var a = e.event.special.mousewheel = {
                        ...
                        setup: function() {
                          if (this.addEventListener) {
                            for (var t = r.length; t;) this.addEventListener(r[--t], l,{ passive: true });
                      ...
                      function l(i) {
                        var r = i || window.event, s = o.call(arguments, 1), l = 0, d = 0, p = 0, h = 0, f = 0, g = 0;
                        if (
                        ...
                        e.fn.select2 = function(t) {
                          ...
                          if ("string" == typeof t) {
                            ...
                            return this.each(function() {
                              ...
                              null == e && window.console && console.error, i = e[t].apply(e, s);
                            }),
