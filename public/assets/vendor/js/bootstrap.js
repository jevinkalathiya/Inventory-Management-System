  ...
  return function() {
    ...
    function X(e) {
      ...
      return n && ("html" === x(n) || "body" === x(n) && "static" === q(n).position) ? t : n || function(e) {
        ...
        for (P(n) && (n = n.host); j(n) && ["html", "body"].indexOf(x(n)) < 0;) {
          var i = q(n);
          if (
            "none" !== i.transform || "none" !== i.perspective || "paint" === i.contain
            || -1 !== ["transform", "perspective"].indexOf(i.willChange) || t && "filter" === i.willChange
    ...
    var Z = {
      ...
      effect: function(e) {
        ...
        null != i && ("string" != typeof i || (i = t.elements.popper.querySelector(i))) && z(t.elements.popper, i)
          && (t.elements.arrow = i);
      },
    ...
    function ne(e) {
      ...
      if (p) {
        ...
        if (
          C === S(n) && "static" !== q(C = K(n)).position && "absolute" === d
          && (x = "scrollHeight", L = "scrollWidth"), c === r || (c === s || c === a) && l === f
        ) O = o, b -= (m && C === T && T.visualViewport ? T.visualViewport.height : C[x]) - i.height, b *= h ? 1 : -1;
        if (c === s || (c === r || c === o) && l === f) {
          A = a, _ -= (m && C === T && T.visualViewport ? T.visualViewport.width : C[L]) - i.width, _ *= h ? 1 : -1;
        }
      }
      var j,
      ...
      return _ = D.x,
        ...
        h
          ? Object.assign(
            ...
            ((j = {})[O] = E ? "0" : "",
              j[A] = w ? "0" : "",
              j.transform = (T.devicePixelRatio || 1) <= 1
                ? "translate(" + _ + "px, " + b + "px)"
                : "translate3d(" + _ + "px, " + b + "px, 0)",
              j),
          )
          : Object.assign({}, P, ((t = {})[O] = E ? b + "px" : "", t[A] = w ? _ + "px" : "", t.transform = "", t));
    }
    var ie = {
        name: "computeStyles",
        enabled: !0,
    ...
    function ye(e, t) {
      ...
      var n = t,
        ...
        P = _e({ reference: j, element: C, strategy: "absolute", placement: s }),
    ...
    var Ae = {
      ...
      fn: function(e) {
        var t = e.state,
          ...
          d = u.y;
        null != t.modifiersData.popperOffsets
        && (t.modifiersData.popperOffsets.x += f, t.modifiersData.popperOffsets.y += d), t.modifiersData[i] = l;
      },
    };
    var Oe = {
      name: "popperOffsets",
    ...
    var Te = {
      ...
      fn: function(e) {
        var t = e.state,
          ...
          y = n.tetherOffset,
          b = void 0 === y ? 0 : y,
          k = ye(t, { boundary: h, rootBoundary: p, padding: m, altBoundary: v }),
          w = I(t.placement),
          E = ee(t.placement),
          A = !E,
          O = Y(w),
    ...
    function Ce(e, t, n) {
      ...
      var i,
        ...
        o = j(t),
        a = j(t) && function(e) {
          var t = e.getBoundingClientRect(), n = F(t.width) / e.offsetWidth || 1, i = F(t.height) / e.offsetHeight || 1;
          return 1 !== n || 1 !== i;
        }(t),
        s = K(t),
        c = R(e, a, n),
      ...
      return (o || !o && !n)
        && (("body" !== x(t) || de(s))
          && (l = (i = t) !== S(i) && j(i) ? { scrollLeft: (r = i).scrollLeft, scrollTop: r.scrollTop } : ue(i)),
          j(t) ? ((u = R(t, !0)).x += t.clientLeft, u.y += t.clientTop) : s && (u.x = fe(s))),
          ...
          u = {
            ...
            forceUpdate: function() {
              if (!l) {
                ...
                if (Le(t, n)) {
                  s.rects = { reference: Ce(t, X(n), "fixed" === s.options.strategy), popper: B(n) },
                    s.reset = !1,
                  ...
                  for (var i = 0; i < s.orderedModifiers.length; i++) {
                    if (!0 !== s.reset) {
                      var r = s.orderedModifiers[i], o = r.fn, a = r.options, c = void 0 === a ? {} : a, f = r.name;
    ...
    var nt = new Map(),
      ...
      ft = function(e) {
        ...
        var t = "visible" === getComputedStyle(e).getPropertyValue("visibility"), n = e.closest("details:not([open])");
        if (!n) return t;
        if (n !== e) {
      ...
      yt = function(e) {
        ...
        t = function() {
          ...
          "loading" === document.readyState
            ? (gt.length || document.addEventListener("DOMContentLoaded", function() {
      ...
      if ("string" == typeof t && e) {
        ...
        if (t in xt) {
          s = function(e) {
            return function(t) {
              if (
                !t.relatedTarget || t.relatedTarget !== t.delegateTarget && !t.delegateTarget.contains(t.relatedTarget)
                ...
                return function i(r) {
                  for (var o = e.querySelectorAll(t), a = r.target; a && a !== this; a = a.parentNode) {
                    ...
                    try {
                      for (c.s(); !(s = c.n()).done;) {
                        if (s.value === a) {
                          return Wt(r, { delegateTarget: a }), i.oneOff && Ht.off(e, r.type, t, n), n.apply(a, [r]);
                        }
                      }
                    } catch (e) {
                      c.e(e);
      ...
      off: function(e, t, n, i) {
        if ("string" == typeof t && e) {
          var r = $e(Dt(t, n, i), 3),
            ...
            f = t.startsWith(".");
          if (void 0 === a) {
            if (f) { for (var d = 0, h = Object.keys(l); d < h.length; d++) Mt(e, l, h[d], t.slice(1)); }
      ...
      Qt = function() {
        return Xe(function e() {
          ...
          value: function(e, t) {
            ...
            return Ve(
              Ve(Ve(Ve({}, this.constructor.Default), "object" === tt(n) ? n : {}), lt(t) ? Vt(t) : {}),
              "object" === tt(e) ? e : {},
            );
          },
        }, {
          ...
          value: function(e) {
            for (
              var t,
                n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.constructor.DefaultType,
                i = 0,
                r = Object.entries(n);
              i < r.length;
              i++
              ...
              var o = $e(r[i], 2),
                ...
                l = lt(c)
                  ...
                  : null == (t = c)
                  ? "".concat(t)
                  : Object.prototype.toString.call(t).match(/\s([a-z]+)/i)[1].toLowerCase();
              if (!new RegExp(s).test(l)) {
                throw new TypeError(
                  "".concat(this.constructor.NAME.toUpperCase(), ": Option \"").concat(a, "\" provided type \"").concat(
                    l,
                    "\" but expected type \"",
                  ).concat(s, "\"."),
                );
      ...
      Ut = function(e) {
        function t(e, n) {
          ...
          return Qe(this, t),
            i = Fe(this, t),
            (e = ut(e))
              ? (i._element = e, i._config = i._getConfig(n), it(i._element, i.constructor.DATA_KEY, i), i)
              : He(i);
        }
        return Be(t, e),
          Xe(t, [{
    ...
    var an = ".bs.swipe",
      ...
      Nn = { interval: 5e3, keyboard: !0, pause: "hover", ride: !1, touch: !0, wrap: !0 },
      Mn = {
      ...
      Fn = function(e) {
        function t(e, n) {
          ...
          return Qe(this, t),
            ...
            i.touchTimeout = null,
            i._swipeHelper = null,
            i._indicatorsElement = Yt.findOne(".carousel-indicators", i._element),
          ...
          Xe(t, [{
            ...
            value: function() {
              ...
              if (!this._isTransitioning && !this._isShown()) {
                ...
                if (
                  this._config.parent
                  && (n = this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(function(t) {
                    return t !== e._element;
                  }).map(function(e) {
      ...
      wi = function(e) {
        function t(e, n) {
          ...
          return Qe(this, t),
            ...
            i._menu = Yt.next(i._element, hi)[0] || Yt.prev(i._element, hi)[0] || Yt.findOne(hi, i._parent),
        ...
        return Be(t, e),
          Xe(t, [{
            ...
            value: function(e) {
              if (
                "object" === tt((e = Ne(t, "_getConfig", this, 3)([e])).reference) && !lt(e.reference)
            ...
            value: function() {
              ...
              "parent" === this._config.reference
                ...
                : "object" === tt(this._config.reference) && (e = this._config.reference);
            ...
            value: function() {
              ...
              return (this._inNavbar || "static" === this._config.display)
                && (zt(this._menu, "popper", "static"), e.modifiers = [{ name: "applyStyles", enabled: !1 }]),
            ...
            value: function(e) {
              var t = e.key,
                n = e.target,
                i = Yt.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter(
                  function(e) {
                    return ft(e);
                  },
                );
                ...
                try {
                  for (i.s(); !(n = i.n()).done;) {
                    ...
                    if (o && !1 !== o._config.autoClose) {
                      ...
                      if (
                        !(a.includes(o._element) || "inside" === o._config.autoClose && !s
            ...
            value: function(e) {
              var n = /input|textarea/i.test(e.target.tagName), i = "Escape" === e.key, r = [ti, ni].includes(e.key);
              if ((r || i) && (!n || i)) {
                e.preventDefault();
                var o = this.matches(fi)
                    ? this
                    : Yt.prev(this, fi)[0] || Yt.next(this, fi)[0] || Yt.findOne(fi, e.delegateTarget.parentNode),
    ...
    var Ei = "backdrop",
      ...
      nr = { backdrop: "(boolean|string)", focus: "boolean", keyboard: "boolean" },
      ir = function(e) {
        function t(e, n) {
          var i;
          return Qe(this, t),
            (i = Fe(this, t, [e, n]))._dialog = Yt.findOne(".modal-dialog", i._element),
          ...
          Xe(t, [{
            ...
            value: function(e) {
              ...
              this._isShown || this._isTransitioning
                || (Ht.trigger(this._element, Ki, { relatedTarget: e }).defaultPrevented
                  || (this._isShown = !0,
                    this._isTransitioning = !0,
              ...
              Ht.on(this._element, $i, function(t) {
                ...
                Ht.on(this._element, Yi, function(t) {
                  Ht.one(e._element, Xi, function(n) {
                    e._element === t.target && e._element === n.target
            ...
            value: function() {
              ...
              if (!Ht.trigger(this._element, qi).defaultPrevented) {
                ...
                "hidden" === n || this._element.classList.contains(er)
    ...
    var rr = ".".concat("bs.offcanvas"),
      ...
      br = { backdrop: "(boolean|string)", keyboard: "boolean", scroll: "boolean" },
      kr = function(e) {
        function t(e, n) {
          var i;
          return Qe(this, t),
    ...
    var Tr = {
      ...
      xr = { entry: "(string|element|function|null)", selector: "(string|element)" },
      Sr = function(e) {
        function t(e) {
          var n;
        ...
        return Be(t, e),
          Xe(t, [{
            ...
            value: function(e, t, n) {
              ...
              i && ((t = this._resolvePossibleFunction(t))
                ? lt(t)
          ...
          Xe(t, [{
            ...
            value: function() {
              clearTimeout(this._timeout),
                Ht.off(this._element.closest(Dr), Ir, this._hideModalHandler),
              ...
              if (this._isWithContent() && this._isEnabled) {
                ...
                if (!t.defaultPrevented && n) {
                  ...
                  if (
                    ...
                    || (r.append(i), Ht.trigger(this._element, this.constructor.eventName("inserted"))),
                  ...
                  this._queueCallback(
                    function() {
                      Ht.trigger(e._element, e.constructor.eventName("shown")),
                  ...
                  function() {
                    e._isWithActiveTrigger()
                      || (e._isHovered || e._disposePopper(),
                        ...
                        Ht.trigger(e._element, e.constructor.eventName("hidden")));
                  },
                  this.tip,
                  this._isAnimated(),
                );
            ...
            value: function() {
              ...
              try {
                for (n.s(); !(e = n.n()).done;) {
                  var i = e.value;
                  if ("click" === i) {
                    Ht.on(this._element, this.constructor.eventName("click"), this._config.selector, function(e) {
                    ...
                    Ht.on(this._element, r, this._config.selector, function(e) {
                      ...
                      Ht.on(this._element, o, this._config.selector, function(e) {
                        var n = t._initializeOnDelegatedTarget(e);
                        n._activeTrigger["focusout" === e.type ? Mr : Nr] = n._element.contains(e.relatedTarget),
                          n._leave();
                      });
                  }
                }
            ...
            value: function() {
              ...
              e
                && (this._element.getAttribute("aria-label") || this._element.textContent.trim()
            ...
            value: function(e) {
              ...
              return e = Ve(Ve({}, t), "object" === tt(e) && e ? e : {}),
            ...
            key: "_configAfterMerge",
            value: function(e) {
              return e.container = !1 === e.container ? document.body : ut(e.container),
    ...
    var Br = Ve(Ve({}, Rr.Default), {}, {
      ...
      zr = Ve(Ve({}, Rr.DefaultType), {}, { content: "(null|string|element|function)" }),
      qr = function(e) {
        function t() {
          return Qe(this, t), Fe(this, t, arguments);
        }
      ...
      eo = function(e) {
        ...
        return Be(t, e),
          Xe(t, [{
            ...
            key: "_configAfterMerge",
            value: function(e) {
              return e.target = ut(e.target) || document.body,
            ...
            value: function() {
              var e = this;
              this._config.smoothScroll && (Ht.off(this._config.target, Qr),
            ...
            value: function(e) {
              if (e.classList.contains("dropdown-item")) {
                Yt.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(Xr);
              } else {
                ...
                try {
                  for (n.s(); !(t = n.n()).done;) {
                    ...
                    try {
                      for (o.s(); !(i = o.n()).done;) i.value.classList.add(Xr);
                    } catch (e) {
                      o.e(e);
                    } finally {
                      o.f();
            ...
            value: function(e) {
              ...
              try {
                for (n.s(); !(t = n.n()).done;) t.value.classList.remove(Xr);
              } catch (e) {
                n.e(e);
              } finally {
                n.f();
    ...
    var to = ".".concat("bs.tab"),
      ...
      Ao = ".".concat(mo, "[data-bs-toggle=\"tab\"], .").concat(mo, "[data-bs-toggle=\"pill\"], .").concat(
        mo,
        "[data-bs-toggle=\"list\"]",
      ),
      Oo = function(e) {
        function t(e) {
          var n;
          return Qe(this, t),
            (n = Fe(this, t, [e]))._parent = n._element.closest(".list-group, .nav, [role=\"tablist\"]"),
            n._parent
          ...
          Xe(t, [{
            ...
            value: function() {
              ...
              if (!this._elemIsActive(e)) {
                ...
                Ht.trigger(e, ro, { relatedTarget: t }).defaultPrevented || n && n.defaultPrevented
            ...
            value: function(e) {
              if ([lo, uo, fo, ho, po, vo].includes(e.key)) {
                ...
                if ([po, vo].includes(e.key)) n = i[e.key === po ? 0 : i.length - 1];
                else {
