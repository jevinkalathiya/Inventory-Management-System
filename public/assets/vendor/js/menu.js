      ...
      a = function() {
        function e(t) {
          ...
          if (
            function(e, t) {
              ...
              this._rtl = "rtl" === document.documentElement.getAttribute("dir")
          ...
          this._horizontal && window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT
            ? this.switchMenu("vertical")
            : this._bindEvents(),
            t.menuInstance = this,
            "true" === localStorage.getItem("templateCustomizer-".concat(templateName, "--SemiDark"))
        ...
        return t = e,
          n = [{
            ...
            value: function() {
              ...
              this._evntElClick = function(n) {
                ...
                (!this._showDropdownOnHover && this._horizontal || !this._horizontal || window.Helpers.isMobileDevice)
                ...
                this._horizontal && (this._evntPrevBtnClick = function(e) {
                  ...
                  this._evntBodyClick = function(e) {
                    !t._inner.contains(e.target) && t._el.querySelectorAll(".menu-inner > .menu-item.open").length
                      && t.closeAll();
                  },
                  ...
                  this._showDropdownOnHover && (this._evntElMouseOver = function(e) {
                    ...
                    this._horizontal && window.screen.width > window.Helpers.LAYOUT_BREAKPOINT
                    && this._el.addEventListener("mouseover", this._evntElMouseOver),
                    this._evntElMouseOut = function(n) {
                      var i = n.currentTarget, o = n.target, r = n.toElement || n.relatedTarget;
                      if (
                        o.closest("ul") && o.closest("ul").classList.contains("menu-inner") && (t._topParent = o),
                          o !== i && (o.parentNode.classList.contains("open") || !o.classList.contains("menu-toggle"))
                          && r && r.parentNode && !r.parentNode.classList.contains("menu-link")
                      ) {
                        if (t._topParent && !e.childOf(r, t._topParent.parentNode)) {
                          var s = t._topParent.classList.contains("menu-toggle") ? t._topParent : null;
                          s
                            && (n.preventDefault(),
                              "true" !== s.getAttribute("data-hover") && (t.toggle(s), t._topParent = null));
                        }
            ...
            value: function() {
              this._evntElClick && (this._el.removeEventListener("click", this._evntElClick), this._evntElClick = null),
                ...
                && (this._el.removeEventListener("mouseover", this._evntElMouseOver), this._evntElMouseOver = null),
                this._evntElMouseOut
                && (this._el.removeEventListener("mouseout", this._evntElMouseOut), this._evntElMouseOut = null),
                this._evntWindowResize
                && (window.removeEventListener("resize", this._evntWindowResize), this._evntWindowResize = null),
                this._evntBodyClick
                && (document.body.removeEventListener("click", this._evntBodyClick), this._evntBodyClick = null),
            ...
            value: function(t) {
              var n = this,
                ...
                r = e._getItem(t, !0),
                s = e._getLink(t, !0);
              r.classList.contains("open") && !r.classList.contains("disabled")
                && e._promisify(this._onClose, this, r, s, e._findMenu(r), o).then(function() {
                  if (n._horizontal && e._isRoot(r)) {
                    n._toggleDropdown(!1, r, i), n._onClosed && n._onClosed(n, r, s, e._findMenu(r));
            ...
            value: function(t, n) {
              for (
                var i = e._findChild(t.parentNode, ["menu-item", "open"]), o = 0, r = i.length; o < r; o++
            ...
            value: function(t, n, i) {
              ...
              if (t) {
                ...
                u - 5 <= -1 * a
                  ...
                  : u + a + c + 5 >= l && (this._innerPosition = c > l ? -1 * u : -1 * (u + c - l)),
                  r.classList.add("open");
                var d = Math.round(o.getBoundingClientRect().width);
                s
                  ? u + this._innerPosition + 2 * d > l && d < l && d >= c
                    && (o.style.left = [this._rtl ? "100%" : "-100%"])
                  : u + this._innerPosition + d > l && d < l && d > c
                    && (o.style[this._rtl ? "marginRight" : "marginLeft"] = "-".concat(d - c, "px")),
                  this._closeOther(r, i),
                  this._updateSlider();
              } else {
                var h = e._findChild(n, ["menu-toggle"]);
                if (
                  h.length && h[0].removeAttribute("data-hover", "true"),
            ...
            value: function(e) {
              ...
              "next" === e
                ? i + (t = this._getSlideNextPos()) < n && (t = n - i)
                : (t = this._getSlidePrevPos()) > 0 && (t = 0),
            ...
            value: function(t, n) {
              for (var i = [], o = null; t;) {
                t.classList.contains("disabled")
                  ? (o = null, i = [])
                  : (t.classList.contains("open") || (o = t), i.push(t)), t = e._findParent(t, "menu-item", !1);
              }
              if (!o) return null;
            ...
            value: function(t, n, i) {
              var o = this, r = e._getLink(n, !0), s = e._findMenu(n);
            ...
            value: function(e) {
              for (
                var t = this._inner.childNodes[0], n = 0; t !== e;
            ...
            value: function() {
              ...
              o < i || window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT
                ...
                o > i && window.innerWidth > window.Helpers.LAYOUT_BREAKPOINT
                && (0 === r ? this._prevBtn.classList.add("disabled") : this._prevBtn.classList.remove("disabled"),
            ...
            value: function() {
              for (
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._closeChildren,
                  t = this._el.querySelectorAll(".menu-inner > .menu-item.open"),
                  n = 0,
                  i = t.length;
                n < i;
                n++
            ...
            key: "manageScroll",
            value: function() {
              var e = window.PerfectScrollbar, t = document.querySelector(".menu-inner");
            ...
            value: function(t) {
              ...
              if ("vertical" === t) {
                ...
                this._horizontal = !1,
                  ...
                  void 0 !== h
                  && (this._psScroll = new h(document.querySelector(".menu-inner"), {
                    suppressScrollX: !0,
                    wheelPropagation: !e._hasClass("layout-menu-fixed layout-menu-fixed-offcanvas"),
                  })),
                ...
                this._horizontal = !0,
                  ...
                  (f = s.classList).add.apply(
                    f,
                    ["layout-menu-horizontal", "menu", "menu-horizontal", "container-fluid", "flex-grow-0"].concat([
                      this._menuBgClass,
                    ]),
                  ),
              ...
              localStorage.getItem("templateCustomizer-".concat(templateName, "--SemiDark"))
              && s.setAttribute("data-bs-theme", "dark"), this._bindEvents();
            },
          }, {
            key: "destroy",
            value: function() {
              if (this._el) {
                ...
                for (
                  var o = this._el.querySelectorAll(".menu-menu"), r = 0, s = o.length; r < s; r++
                ) o[r].style.marginRight = null, o[r].style.marginLeft = null;
          ...
          o = [{
            ...
            value: function(e) {
              for (
                var t = e.childNodes[0], n = null; t && !n;
              ) t.classList && t.classList.contains("menu-sub") && (n = t), t = t.nextSibling;
            ...
            key: "_hasClass",
            value: function(e) {
              var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : window.Helpers.ROOT_EL, n = !1;
            ...
            key: "_getItem",
            value: function(t, n) {
              var i = null, o = n ? "menu-toggle" : "menu-link";
              if (
                t.classList.contains("menu-item")
                  ? e._findChild(t, [o]).length && (i = t)
                  : t.classList.contains(o) && (i = t.parentNode.classList.contains("menu-item") ? t.parentNode : null),
                  !i
            ...
            key: "_getLink",
            value: function(t, n) {
              var i = [], o = n ? "menu-toggle" : "menu-link";
              if (
                t.classList.contains(o) ? i = [t] : t.classList.contains("menu-item") && (i = e._findChild(t, [o])),
                  !i.length
            ...
            value: function(e) {
              ...
              && (clearTimeout(e._menuAnimationEndEventTimeout), e._menuAnimationEndEventTimeout = null),
