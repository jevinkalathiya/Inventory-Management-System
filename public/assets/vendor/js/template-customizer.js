        ...
        return (
            (function() {
                ...
                y = S.contains("layout-navbar-fixed") ?
                    ...
                    "static";
                var z,
                    w = document.documentElement.getAttribute("data-bs-theme") || "light",
                    C =
                    document
                            ...
                            if (
                                ...
                                if (
                                    ((this.settings = {}),
                                        ...
                                        n ?
                                        ((this.settings.defaultPrimaryColor = n), (z = !0)) :
                                        ((this.settings.defaultPrimaryColor =
                                                O.getPropertyValue("--bs-primary").trim()),
                                            (z = !1)),
                                        ...
                                        (this.settings.defaultSkin = this._getDefaultSkin(
                                            void 0 !== a ? a : C
                                        )),
                                    ...
                                    1 !== B &&
                                        (this.settings.controls = this.settings.controls
                                            .slice(0, B)
                                            .concat(this.settings.controls.slice(B + 1)));
                                }
                                ...
                                this._loadSettings(),
                                    ...
                                    this.setLayoutNavbarOption(
                                        this.settings.layoutNavbarOptions, !1
                                    ),
                                    this.setLayoutFooterFixed(
                                        this.settings.layoutFooterFixed, !1
                                    ),
                                    this.setDropdownOnHover(
                                        this.settings.showDropdownOnHover, !1
                                    ),
                                    this._setup();
                            }
                        }
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        if (
                                            ...
                                            "fixed" === this.settings.headerType ||
                                                "fixed-offcanvas" === this.settings.headerType ?
                                                i &&
                                                o &&
                                                (window.Helpers.menuPsScroll.destroy(),
                                                    ...
                                                    (window.Helpers.menuPsScroll = o)) :
                                                o && window.Helpers.menuPsScroll.destroy();
                                        }
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function() {
                                        ...
                                        t || o || i || a || s || l || u || e || n ?
                                            ...
                                            e && (z = !0),
                                            (this.settings.color =
                                                e || this.settings.defaultPrimaryColor),
                                            this.setColor(this.settings.color, z),
                                            (this.settings.themesOpt = this.settings.themes.includes(
                                                    o
                                                ) ?
                                                o :
                                        ...
                                        (d = this.settings.themes.includes(o) ?
                                            ...
                                            m :
                                            o :
                                            "system" === this.settings.defaultTheme ?
                                            m :
                                            this.settings.defaultTheme),
                                        ...
                                        document.documentElement.setAttribute("data-bs-theme", d),
                                            ...
                                            (this.settings.contentLayout =
                                                a || this.settings.defaultContentLayout),
                                            ...
                                            (this.settings.showDropdownOnHover = r ?
                                                "true" === r :
                                                this.settings.defaultShowDropdownOnHover),
                                            ...
                                            (this.settings.skin = this._getSkinByName(
                                                this._getSetting("Skin"), !0
                                            )),
                                            this._hasControls("rtl") ||
                                            (this.settings.rtl =
                                                "rtl" ===
                                            ...
                                            (this.settings.theme = window.Helpers.isDarkStyle() ?
                                                "dark" :
                                                "light"),
                                            this._hasControls("contentLayout") ||
                                            (this.settings.contentLayout = null),
                                            this._hasControls("headerType") ||
                                            (this.settings.headerType = null),
                                    ...
                                    value: function() {
                                        ...
                                        this._cleanup(),
                                            ...
                                            this.container.setAttribute(
                                                "style",
                                                "visibility: ".concat(
                                                    this.settings.displayCustomizer ? "visible" : "hidden"
                                                )
                                            );
                                        ...
                                        if (this._hasControls("color")) {
                                            ...
                                            var m = u.querySelector(
                                                'input[value="'.concat(this.settings.color, '"]')
                                            );
                                            m
                                                ?
                                                (m.setAttribute("checked", "checked"),
                                                    u
                                                    .querySelector('input[value="picker"]')
                                            ...
                                            var p = function(e) {
                                                "picker" === e.target.value ?
                                                    ...
                                                    .click() :
                                                    (t._setSetting("Color", e.target.dataset.color),
                                                        t.setColor(
                                        ...
                                        if (this._hasControls("theme")) {
                                            this.settings.availableThemes.forEach(function(t) {
                                                ...
                                                g.querySelector(
                                                    'input[value="'.concat(this.settings.themesOpt, '"]')
                                                ) &&
                                                g
                                                .querySelector(
                                                    'input[value="'.concat(
                                        ...
                                        if (
                                            this._hasControls(
                                                "contentLayout headerType layoutCollapsed layoutNavbarOptions rtl", !0
                                            )
                                        ) {
                                            var C = this.container.querySelector(
                                            ...
                                            if (this._hasControls("layoutCollapsed")) {
                                                ...
                                                this.settings.availableMenuCollapsed.forEach(function(
                                                        t
                                                    ) {
                                            ...
                                            if (this._hasControls("contentLayout")) {
                                                ...
                                                this.settings.availableContentLayouts.forEach(function(
                                                        t
                                                    ) {
                                                        var e = o(
                                                            t.name,
                                            ...
                                            if (this._hasControls("headerType")) {
                                                ...
                                                setTimeout(function() {
                                                    ...
                                                    this.settings.availableHeaderTypes.forEach(function(
                                                        t
                                                    ) {
                                                        var e = o(
                                                            t.name,
                                            ...
                                            if (this._hasControls("layoutNavbarOptions")) {
                                                ...
                                                this.settings.availableNavbarOptions.forEach(function(
                                                        t
                                                    ) {
                                                        var e = o(
                                                            t.name,
                                            ...
                                            if (this._hasControls("rtl")) {
                                                ...
                                                var P = function(e) {
                                                    ...
                                                    i &&
                                                        i
                                                        .querySelector('[data-language="'.concat(o, '"]'))
                                                        .click(),
                                                        t._initDirection(),
                                        ...
                                        setTimeout(function() {
                                                ...
                                                document.documentElement.getAttribute(
                                                    ...
                                                    ("dark" ===
                                                        ...
                                                        .getAttribute("data-bs-theme") && (i = !0), !0 === i &&
                                                        o
                                                        .querySelector(
                                                            ".template-customizer-semi-dark-switch"
                                                        )
                                                    ...
                                                    t._hasControls(
                                                        "rtl contentLayout layoutCollapsed layoutNavbarOptions", !0
                                                    ) ||
                                                    (e && e.parentNode.removeChild(e)) :
                                                    document.querySelector(".menu-horizontal") &&
                                                    (t._hasControls(
                                                            "rtl contentLayout headerType", !0
                                                        ) ||
                                                        (e && e.parentNode.removeChild(e)));
                                            }, 100),
                                    ...
                                    value: function(t, e) {
                                        ...
                                        try {
                                            localStorage.setItem(
                                                    "templateCustomizer-".concat(o, "--").concat(t),
                                                    String(e)
                                                ),
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        return t.split(" ").reduce(function(t, i) {
                                            return (-1 !== e.settings.controls.indexOf(i) ?
                                                (o || !1 !== t) && (t = !0) :
                                                (o && !0 === t) || (t = !1),
                                                t
                                            );
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        var e =
                                            ...
                                            this.settings.availableSkins[t];
                                        if (!e)
                                    ...
                                    value: function(t) {
                                        for (
                                            var e =
                                                ...
                                                void 0 !== arguments[1] &&
                                                arguments[1],
                                                o = this.settings.availableSkins,
                                                i = 0,
                                                n = o.length; i < n; i++
                                        )
                ...
                (D.COLORS = [{
                    ...
                    { name: "info", title: "Info", color: "#696cff" }, 
                ]),
                (D.THEMES = [{
                        name: "light",
                        title: "Light",
                ...
                (D.LANGUAGES = {
                    ...
                    gu: {
                        panel_header: "ટેમ્પલેટ કસ્ટમાઇઝર",
                        panel_sub_header: "તમે તમારા પૃષ્ઠને કસ્ટમાઇઝ કરી શકો છો",
                        theming_header: "થીમિંગ",
                        color_label: "મૂળ રંગ",
                        theme_label: "થીમ",
                        skin_label: "ચામડા",
                        semiDark_label: "અર્ધ અંધારું",
                        layout_header: "ખાકલો",
                        layout_label: "મેનૂ (નેવિગેશન)",
                        layout_header_label: "હેડર પ્રકારો",
                        content_label: "સામગ્રી",
                        layout_navbar_label: "નાવબાર પ્રકાર",
                        direction_label: "દિશા"
                    },

                    hi: {
                        panel_header: "टेम्पलेट कस्टमाइज़र",
                        panel_sub_header: "अनुकूलन और पूर्वावलोकन करें रीयल टाइम में",
                        theming_header: "थीमिंग",
                        color_label: "प्राथमिक रंग",
                        theme_label: "थीम",
                        skin_label: "स्किन",
                        semiDark_label: "सेमी डार्क",
                        layout_header: "लेआउट",
                        layout_label: "मेनू (नेविगेशन)",
                        layout_header_label: "हेडर प्रकार",
                        content_label: "सामग्री",
                        layout_navbar_label: "नेवबार प्रकार",
                ...
                window.onload = function() {
                    !(function() {
                        ...
                        if (t.pickerWrapper && t.pickerEl) {
                            var e =
                                "checked" === t.pickerWrapper.getAttribute("checked") ?
