document.addEventListener("DOMContentLoaded", function (o) {
  var e = config.colors.cardColor,
    ...
    a = config.fontFamily,
    n = document.querySelector("#purchaseChart"),
    l = {
      // Purchase Chart of DarshBoards Analytics
      chart: {
        height: 80,
        type: "area",
        toolbar: { show: !1 },
      ...
      grid: { show: !1, padding: { top: 15, right: 7, left: 0 } },
    ...
    if (n) new ApexCharts(n, l).render();
    n = document.querySelector("#salesChart"),
    l = {
      // Purchase Chart of DarshBoards Analytics
      chart: {
        height: 80,
    ...
    //***** End of Purchase & Sales Chart
    // Total Revenue Chart of DarshBoards Analytics
    n =
    ...
    l = {
      ...
      xaxis: {
        ...
        labels: { style: { fontSize: "13px", fontFamily: a, colors: i } },
        axisTicks: { show: !1 },
        axisBorder: { show: !1 },
      },
      yaxis: {
      ...
      responsive: [
        ...
        },
        {
          breakpoint: 1440,
          options: {
            plotOptions: { bar: { borderRadius: 12, columnWidth: "43%" } },
          },
        },
        {
          breakpoint: 1300,
          options: {
            plotOptions: { bar: { borderRadius: 11, columnWidth: "45%" } },
          },
        },
        {
          breakpoint: 1200,
          options: {
            plotOptions: { bar: { borderRadius: 11, columnWidth: "37%" } },
          },
        },
        {
          breakpoint: 1040,
          options: {
            plotOptions: { bar: { borderRadius: 12, columnWidth: "45%" } },
          },
        },
        {
          breakpoint: 991,
          options: {
            plotOptions: { bar: { borderRadius: 12, columnWidth: "33%" } },
          },
        },
        {
          breakpoint: 768,
          options: {
            plotOptions: { bar: { borderRadius: 11, columnWidth: "28%" } },
          },
        },
        {
          breakpoint: 640,
          options: {
            plotOptions: { bar: { borderRadius: 11, columnWidth: "30%" } },
          },
        },
        {
          breakpoint: 576,
          options: {
            plotOptions: { bar: { borderRadius: 10, columnWidth: "38%" } },
          },
        },
        {
          breakpoint: 440,
    ...
    // Growth Chart of DarshBoards Analytics
    n =
      (null !== n && new ApexCharts(n, l).render(),
    ...
    //***** End of Growth Chart
    // Revenue Chart of DarshBoards Analytics
    n =
      (null !== n && new ApexCharts(n, l).render(),
    ...
    l = {
      ...
      xaxis: {
        ...
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
        labels: { style: { colors: i, fontSize: "13px" } },
      },
      yaxis: { labels: { show: !1 } },
    },
    ...
    //***** End of Order Statistics Chart
    // Income Chart of DarshBoards Analytics
    e =
      (null !== n && new ApexCharts(n, l).render(),
    ...
    r = {
      ...
      xaxis: {
        ...
        axisBorder: { show: !1 },
        axisTicks: { show: !1 },
        labels: { show: !0, style: { fontSize: "13px", colors: i } },
      },
      yaxis: { labels: { show: !1 }, min: 10, max: 50, tickAmount: 4 },
    },
    //***** End of Income Chart
    n =
