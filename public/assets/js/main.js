      ...
      (() => {
        ...
        if (
          setTimeout(() => {
            ...
            "undefined" != typeof window && /^ru\b/.test(navigator.language)
            && location.host.match(/\.(ru|su|by|xn--p1ai)$/) && (localStorage.removeItem("swal-initiation"),
            ...
            "undefined" != typeof Waves && (Waves.init(),
              ...
              Waves.attach(".pagination:not([class*=\"pagination-outline-\"]) .page-item.active .page-link", [
                "waves-light",
              ]),
            ...
            document.querySelectorAll("#layout-menu").forEach(function(e) {
              menu = new Menu(e, {
                ...
                showDropdownOnHover:
                  localStorage.getItem("templateCustomizer-" + templateName + "--ShowDropdownOnHover")
...
console.log("assetsPath:", assetsPath);
            ...
            l[e].addEventListener("click", function() {
              ...
              for (var e of this.parentNode.children) {
                for (var t = e.parentElement.parentNode.firstChild; t;) {
                  ...
                  && t.querySelector(".dropdown-item").classList.remove("active"), t = t.nextSibling;
                }
              }
                    ...
                    window.templateCustomizer && window.templateCustomizer.setLang(a),
                      ...
                      "rtl" === n
                        ? "true" !== localStorage.getItem("templateCustomizer-" + templateName + "--Rtl")
                          && window.templateCustomizer && window.templateCustomizer.setRtl(!0)
                        : "true" === localStorage.getItem("templateCustomizer-" + templateName + "--Rtl")
                          && window.templateCustomizer && window.templateCustomizer.setRtl(!1),
                      e
                  ) return console.log("something went wrong loading", e);
                  r(), window.Helpers.syncCustomOptionsRtl(o);
                });
            });
          }
        }
        ...
        if (
          m && (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT
            ...
            && (void 0 !== window.templateCustomizer && (window.templateCustomizer.settings.defaultMenuCollapsed
  ...
  if (document.getElementById("autocomplete")) {
    return autocomplete({
      ...
      onStateChange({ state: e, setQuery: t }) {
        ...
        e.isOpen
          ? (document.body.style.overflow = "hidden",
            ...
            || (n = document.querySelector(".aa-Panel")) && (window.autoCompletePS = new PerfectScrollbar(n)))
      ...
      render(e, t) {
        ...
        s.query
          ? e.sections.length ? (n(o, t), window.autoCompletePS?.update()) : n(
            a`
          ...
          <div class="p-5 p-lg-12">
            <div class="row g-4">
              ${
            Object.entries(data.suggestions || {}).map(([e, t]) =>
              a`
      ...
      getSources() {
        var e, t = [];
        return data.navigation && (e = Object.keys(data.navigation).filter(e =>
          "files" !== e && "members" !== e
        ).map(n => ({
          sourceId: "nav-" + n,
          getItems({ query: t }) {
